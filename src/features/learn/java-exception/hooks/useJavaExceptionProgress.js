...
const LOCAL_KEY           = "java_exception_progress";
const LOCAL_CODE_KEY      = "java_exception_saved_code";
const LOCAL_NOTES_KEY     = "java_exception_notes";
const LOCAL_BOOKMARKS_KEY = "java_exception_bookmarks";
const LOCAL_LAST_KEY      = "java_exception_last_lesson";
