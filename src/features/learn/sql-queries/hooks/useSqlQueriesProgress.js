...
const LOCAL_KEY = "sqlqueries_progress";
const LOCAL_CODE_KEY = "sqlqueries_saved_code";
const LOCAL_BOOKMARKS_KEY = "sqlqueries_bookmarks";
const LOCAL_LAST_KEY = "sqlqueries_last_lesson";
...
export default function useSqlQueriesProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "sql-queries", lesson);
    },
