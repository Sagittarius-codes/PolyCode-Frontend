...
const LOCAL_KEY = "php_forms_progress";
const LOCAL_CODE_KEY = "php_forms_saved_code";
const LOCAL_BOOKMARKS_KEY = "php_forms_bookmarks";
const LOCAL_LAST_KEY = "php_forms_last_lesson";
...
export default function usePhpFormsProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "php-forms", lesson);
    },
