...
const LOCAL_KEY           = "java_collections_progress";
const LOCAL_CODE_KEY      = "java_collections_saved_code";
const LOCAL_NOTES_KEY     = "java_collections_notes";
const LOCAL_BOOKMARKS_KEY = "java_collections_bookmarks";
const LOCAL_LAST_KEY      = "java_collections_last_lesson";
