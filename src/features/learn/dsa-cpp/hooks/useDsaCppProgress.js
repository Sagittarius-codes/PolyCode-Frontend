...
const LOCAL_KEY = "dsa_cpp_progress";
const LOCAL_CODE_KEY = "dsa_cpp_saved_code";
const LOCAL_BOOKMARKS_KEY = "dsa_cpp_bookmarks";
const LOCAL_LAST_KEY = "dsa_cpp_last_lesson";
...
export default function useDsaCppProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "dsa-cpp", lesson);
    },
