...
const LOCAL_KEY = "js_oops_progress";
const LOCAL_CODE_KEY = "js_oops_saved_code";
const LOCAL_NOTES_KEY = "js_oops_notes";
const LOCAL_BOOKMARKS_KEY = "js_oops_bookmarks";
const LOCAL_LAST_KEY = "js_oops_last_lesson";
