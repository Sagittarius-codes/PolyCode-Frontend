...
const LOCAL_KEY           = "java_multithreading_progress";
const LOCAL_CODE_KEY      = "java_multithreading_saved_code";
const LOCAL_NOTES_KEY     = "java_multithreading_notes";
const LOCAL_BOOKMARKS_KEY = "java_multithreading_bookmarks";
const LOCAL_LAST_KEY      = "java_multithreading_last_lesson";
