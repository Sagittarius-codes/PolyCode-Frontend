...
const LOCAL_KEY = "c_data_structures_progress";
const LOCAL_CODE_KEY = "c_data_structures_saved_code";
const LOCAL_BOOKMARKS_KEY = "c_data_structures_bookmarks";
const LOCAL_LAST_KEY = "c_data_structures_last_lesson";
...
export default function useCDataStructuresProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "c-data-structures", lesson);
    },
