...
const LOCAL_KEY = "c_projects_progress";
const LOCAL_CODE_KEY = "c_projects_saved_code";
const LOCAL_BOOKMARKS_KEY = "c_projects_bookmarks";
const LOCAL_LAST_KEY = "c_projects_last_lesson";
...
export default function useCProjectsProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "c-projects", lesson);
    },
