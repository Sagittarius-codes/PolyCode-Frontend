...
const LOCAL_KEY = "php_sessions_progress";
const LOCAL_CODE_KEY = "php_sessions_saved_code";
const LOCAL_BOOKMARKS_KEY = "php_sessions_bookmarks";
const LOCAL_LAST_KEY = "php_sessions_last_lesson";
...
export default function usePhpSessionsProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "php-sessions", lesson);
    },
