...
const LOCAL_KEY = "python_file_handling_py_progress";
const LOCAL_CODE_KEY = "python_file_handling_py_saved_code";
const LOCAL_BOOKMARKS_KEY = "python_file_handling_py_bookmarks";
const LOCAL_LAST_KEY = "python_file_handling_py_last_lesson";
...
export default function usePythonFileHandlingProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "python-file-handling-py", lesson);
    },
