...
const LOCAL_KEY = "c_file_handling_progress";
const LOCAL_CODE_KEY = "c_file_handling_saved_code";
const LOCAL_BOOKMARKS_KEY = "c_file_handling_bookmarks";
const LOCAL_LAST_KEY = "c_file_handling_last_lesson";
...
export default function useCFileHandlingProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "c-file-handling", lesson);
    },
