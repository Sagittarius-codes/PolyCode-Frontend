...
const LOCAL_KEY = "node_npm_progress";
const LOCAL_CODE_KEY = "node_npm_saved_code";
const LOCAL_BOOKMARKS_KEY = "node_npm_bookmarks";
const LOCAL_LAST_KEY = "node_npm_last_lesson";
...
export default function useNodeNpmProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "node-npm", lesson);
    },
