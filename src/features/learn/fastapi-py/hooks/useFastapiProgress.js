...
const LOCAL_KEY = "fastapi_py_progress";
const LOCAL_CODE_KEY = "fastapi_py_saved_code";
const LOCAL_BOOKMARKS_KEY = "fastapi_py_bookmarks";
const LOCAL_LAST_KEY = "fastapi_py_last_lesson";
...
export default function useFastapiProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "fastapi-py", lesson);
    },
