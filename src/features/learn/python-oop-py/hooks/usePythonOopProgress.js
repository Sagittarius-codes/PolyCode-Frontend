...
const LOCAL_KEY = "python_oop_py_progress";
const LOCAL_CODE_KEY = "python_oop_py_saved_code";
const LOCAL_BOOKMARKS_KEY = "python_oop_py_bookmarks";
const LOCAL_LAST_KEY = "python_oop_py_last_lesson";
...
export default function usePythonOopProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "python-oop-py", lesson);
    },
