...
const LOCAL_KEY           = "java_spring_boot_progress";
const LOCAL_CODE_KEY      = "java_spring_boot_saved_code";
const LOCAL_NOTES_KEY     = "java_spring_boot_notes";
const LOCAL_BOOKMARKS_KEY = "java_spring_boot_bookmarks";
const LOCAL_LAST_KEY      = "java_spring_boot_last_lesson";
