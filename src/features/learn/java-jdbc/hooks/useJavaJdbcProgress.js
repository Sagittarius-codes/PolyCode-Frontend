...
const LOCAL_KEY           = "java_jdbc_progress";
const LOCAL_CODE_KEY      = "java_jdbc_saved_code";
const LOCAL_NOTES_KEY     = "java_jdbc_notes";
const LOCAL_BOOKMARKS_KEY = "java_jdbc_bookmarks";
const LOCAL_LAST_KEY      = "java_jdbc_last_lesson";
