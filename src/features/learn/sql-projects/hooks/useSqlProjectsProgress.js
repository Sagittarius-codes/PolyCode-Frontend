...
const LOCAL_KEY = "sqlprojects_progress";
const LOCAL_CODE_KEY = "sqlprojects_saved_code";
const LOCAL_BOOKMARKS_KEY = "sqlprojects_bookmarks";
const LOCAL_LAST_KEY = "sqlprojects_last_lesson";
...
export default function useSqlProjectsProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "sql-projects", lesson);
    },
