...
const LOCAL_KEY           = "java_projects_progress";
const LOCAL_CODE_KEY      = "java_projects_saved_code";
const LOCAL_NOTES_KEY     = "java_projects_notes";
const LOCAL_BOOKMARKS_KEY = "java_projects_bookmarks";
const LOCAL_LAST_KEY      = "java_projects_last_lesson";
