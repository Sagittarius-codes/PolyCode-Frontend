...
const LOCAL_KEY = "sqlviews_progress";
const LOCAL_CODE_KEY = "sqlviews_saved_code";
const LOCAL_BOOKMARKS_KEY = "sqlviews_bookmarks";
const LOCAL_LAST_KEY = "sqlviews_last_lesson";
...
export default function useSqlViewsProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "sql-views", lesson);
    },
