...
const LOCAL_KEY = "php_projects_progress";
const LOCAL_CODE_KEY = "php_projects_saved_code";
const LOCAL_BOOKMARKS_KEY = "php_projects_bookmarks";
const LOCAL_LAST_KEY = "php_projects_last_lesson";
...
export default function usePhpProjectsProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "php-projects", lesson);
    },
