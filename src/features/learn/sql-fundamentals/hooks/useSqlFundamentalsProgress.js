...
const LOCAL_KEY = "sqlfundamentals_progress";
const LOCAL_CODE_KEY = "sqlfundamentals_saved_code";
const LOCAL_BOOKMARKS_KEY = "sqlfundamentals_bookmarks";
const LOCAL_LAST_KEY = "sqlfundamentals_last_lesson";
...
export default function useSqlFundamentalsProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "sql-fundamentals", lesson);
    },
