...
const LOCAL_KEY = "sqlsubqueries_progress";
const LOCAL_CODE_KEY = "sqlsubqueries_saved_code";
const LOCAL_BOOKMARKS_KEY = "sqlsubqueries_bookmarks";
const LOCAL_LAST_KEY = "sqlsubqueries_last_lesson";
...
export default function useSqlSubqueriesProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "sql-subqueries", lesson);
    },
