...
const LOCAL_KEY = "js_dom_progress";
const LOCAL_CODE_KEY = "js_dom_saved_code";
const LOCAL_BOOKMARKS_KEY = "js_dom_bookmarks";
const LOCAL_LAST_KEY = "js_dom_last_lesson";
...
export default function useJsDomProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "js-dom", lesson);
    },
