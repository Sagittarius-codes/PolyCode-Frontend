...
const LOCAL_KEY = "c_memory_management_progress";
const LOCAL_CODE_KEY = "c_memory_management_saved_code";
const LOCAL_BOOKMARKS_KEY = "c_memory_management_bookmarks";
const LOCAL_LAST_KEY = "c_memory_management_last_lesson";
...
export default function useCMemoryManagementProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "c-memory-management", lesson);
    },
