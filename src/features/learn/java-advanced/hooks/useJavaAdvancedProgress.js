...
const LOCAL_KEY           = "java_advanced_progress";
const LOCAL_CODE_KEY      = "java_advanced_saved_code";
const LOCAL_NOTES_KEY     = "java_advanced_notes";
const LOCAL_BOOKMARKS_KEY = "java_advanced_bookmarks";
const LOCAL_LAST_KEY      = "java_advanced_last_lesson";
