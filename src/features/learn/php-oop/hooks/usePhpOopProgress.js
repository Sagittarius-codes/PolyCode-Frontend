...
const LOCAL_KEY = "php_oop_progress";
const LOCAL_CODE_KEY = "php_oop_saved_code";
const LOCAL_BOOKMARKS_KEY = "php_oop_bookmarks";
const LOCAL_LAST_KEY = "php_oop_last_lesson";
...
export default function usePhpOopProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "php-oop", lesson);
    },
