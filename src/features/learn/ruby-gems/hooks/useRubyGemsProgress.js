...
const LOCAL_KEY = "ruby_gems_progress";
const LOCAL_CODE_KEY = "ruby_gems_saved_code";
const LOCAL_BOOKMARKS_KEY = "ruby_gems_bookmarks";
const LOCAL_LAST_KEY = "ruby_gems_last_lesson";
...
export default function useRubyGemsProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "ruby-gems", lesson);
    },
