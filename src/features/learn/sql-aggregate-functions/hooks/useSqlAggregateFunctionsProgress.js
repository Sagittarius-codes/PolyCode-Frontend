...
const LOCAL_KEY = "sqlaggregatefunctions_progress";
const LOCAL_CODE_KEY = "sqlaggregatefunctions_saved_code";
const LOCAL_BOOKMARKS_KEY = "sqlaggregatefunctions_bookmarks";
const LOCAL_LAST_KEY = "sqlaggregatefunctions_last_lesson";
...
export default function useSqlAggregateFunctionsProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "sql-aggregate-functions", lesson);
    },
