...
const LOCAL_KEY = "php_mysql_progress";
const LOCAL_CODE_KEY = "php_mysql_saved_code";
const LOCAL_BOOKMARKS_KEY = "php_mysql_bookmarks";
const LOCAL_LAST_KEY = "php_mysql_last_lesson";
...
export default function usePhpMysqlProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "php-mysql", lesson);
    },
