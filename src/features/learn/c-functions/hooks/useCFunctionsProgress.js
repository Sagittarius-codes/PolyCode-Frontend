...
const LOCAL_KEY = "c_functions_progress";
const LOCAL_CODE_KEY = "c_functions_saved_code";
const LOCAL_BOOKMARKS_KEY = "c_functions_bookmarks";
const LOCAL_LAST_KEY = "c_functions_last_lesson";
...
export default function useCFunctionsProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "c-functions", lesson);
    },
