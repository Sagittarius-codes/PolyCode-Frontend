...
export default function SqlJoinsHub() {
  ...
  <div className="matplotlib-path-label">
    ...
    <small>
      {SQLJOINS_CHAPTERS.length} chapters · {" "}
      {SQLJOINS_LESSONS.length} lessons
    </small>
  </div>
  <div className="matplotlib-path-grid">
    {LEARNING_PATH.map((stage) => {
      const stageChapters = SQLJOINS_CHAPTERS.filter((ch) =>
