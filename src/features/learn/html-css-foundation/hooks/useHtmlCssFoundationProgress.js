...
const LOCAL_KEY = "html_css_foundation_progress";
const LOCAL_CODE_KEY = "html_css_foundation_saved_code";
const LOCAL_BOOKMARKS_KEY = "html_css_foundation_bookmarks";
const LOCAL_LAST_KEY = "html_css_foundation_last_lesson";
...
export default function useHtmlCssFoundationProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "html-css-foundation", lesson);
    },
