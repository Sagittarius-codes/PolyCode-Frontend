...
const LOCAL_KEY = "sqlstoredprocedures_progress";
const LOCAL_CODE_KEY = "sqlstoredprocedures_saved_code";
const LOCAL_BOOKMARKS_KEY = "sqlstoredprocedures_bookmarks";
const LOCAL_LAST_KEY = "sqlstoredprocedures_last_lesson";
...
export default function useSqlStoredProceduresProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "sql-stored-procedures", lesson);
    },
