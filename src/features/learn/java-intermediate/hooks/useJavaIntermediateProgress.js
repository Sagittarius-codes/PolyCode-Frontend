...
const LOCAL_KEY           = "java_intermediate_progress";
const LOCAL_CODE_KEY      = "java_intermediate_saved_code";
const LOCAL_NOTES_KEY     = "java_intermediate_notes";
const LOCAL_BOOKMARKS_KEY = "java_intermediate_bookmarks";
const LOCAL_LAST_KEY      = "java_intermediate_last_lesson";
