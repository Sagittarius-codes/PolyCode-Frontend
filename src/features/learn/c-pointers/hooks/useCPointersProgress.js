...
const LOCAL_KEY = "c_pointers_progress";
const LOCAL_CODE_KEY = "c_pointers_saved_code";
const LOCAL_BOOKMARKS_KEY = "c_pointers_bookmarks";
const LOCAL_LAST_KEY = "c_pointers_last_lesson";
...
export default function useCPointersProgress() {
  ...
  const completeLesson = useCallback(
    async (lesson) => {
      ...
      refreshLocal();
      recordLessonXp(token, "c-pointers", lesson);
    },
