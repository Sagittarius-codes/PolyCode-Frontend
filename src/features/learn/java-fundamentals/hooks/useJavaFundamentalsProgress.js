...
const LOCAL_KEY           = "java_fundamentals_progress";
const LOCAL_CODE_KEY      = "java_fundamentals_saved_code";
const LOCAL_NOTES_KEY     = "java_fundamentals_notes";
const LOCAL_BOOKMARKS_KEY = "java_fundamentals_bookmarks";
const LOCAL_LAST_KEY      = "java_fundamentals_last_lesson";
